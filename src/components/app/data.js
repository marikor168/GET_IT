...
export const errorData = [
  ...
  {id: 4, kind: "textarea", htmlFor:"error_description", labelName:"Подробное описание ошибки", type:"text", name: "error_description", placeholder: "Опишите ошибку подробно"},
  {id: 5, kind: "input", htmlFor:"user", labelName:"Пользователь", type: "text", name: "user", placeholder: "Пользователь", disabled: true, required: false},
  {id: 6, kind: "select", htmlFor:"status", labelName:"Статус ошибки", name: "status", options: statusItems },
  {id: 7, kind: "select", htmlFor:"priority", labelName:"Приоритет", name: "priority", options: priorityItems },
  {id: 8, kind: "select", htmlFor:"seriousness", labelName:"Серьёзность", name: "seriousness", options: seriousnessItems },
];
